...
Note: This is a research request. Analyze the URL content and provide comprehensive legal research findings.`
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <label className="block text-sm font-medium text-gray-700">URL to Deep Research</label>
      ...
      case "case-database":
        return (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500">Search through your case database to uncover insights and precedents.</p>
          </div>
        )
      case "ai-assistant":
      default:
        return (
          <div className="space-y-4">
            <label className="block text-sm font-medium text-gray-700">Ask a Legal Question</label>
            <textarea
              value={aiQuestion}
            ...
            <p className="text-xs text-gray-500">Ctrl + ` to toggle full insight view.</p>
          </div>
        )
    }
  }
          ...
          <div className="space-y-4">
            ...
            {searchResult ? (
              ...
              <div className="bg-white border border-dashed border-gray-300 rounded-lg p-8 text-center text-sm text-gray-500">
                Input a URL and run deep research to view summarized insights here.
              </div>
            )}
          </div>
        )
        ...
        return (
          <div className="space-y-4">
            ...
            {aiAnswer ? (
              ...
              <div className="bg-white border border-dashed border-gray-300 rounded-lg p-8 text-center text-sm text-gray-500">
                Ask a detailed question to receive precedents, statutes, and analysis tailored to your search context.
              </div>
            )}
          </div>
        )
  ...
  const controlsContent = renderControls()
      ...
      <motion.div className="flex-1 ml-[280px] p-8" layout>
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div layout className="bg-white rounded-lg shadow-sm overflow-hidden">
            <div className="border-b border-gray-200 flex items-center justify-between px-6 py-4">
              <div className="flex gap-1">
                <button
                  ...
                  className={`px-6 py-2 font-medium text-sm border-b-2 transition ${
            ...
            <motion.div layout className="p-6 lg:p-8 flex flex-col lg:flex-row gap-8">
              <AnimatePresence initial={false} mode="sync">
                {!isFullView && (
                  <motion.div
                    key="hakilens-controls"
                    layout

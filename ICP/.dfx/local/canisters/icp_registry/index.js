...
import { idlFactory } from './icp_registry.did.js';
export { idlFactory } from './icp_registry.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_REGISTRY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_registry.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_registry canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_registry.did.js")._SERVICE>}
 */
export const icp_registry = createActor(canisterId);
